...
<div class="mx-6 my-4 md:hidden">
	<svg on:click={handleClick} class="bg-neutral-700 rounded-lg shadow shadow-neutral-700" xmlns="http://www.w3.org/2000/svg" viewBox="-5 -7 24 24" width="60" fill="currentColor"
		><path
